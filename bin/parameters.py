...
aux1 = 0.0  # Auxiliary variable, useful e.g. for ramps
aux2 = 0.0
aux3 = 0.0
...
forcing = 10  # Radial, symmetric, order m boundary flow forcing.

# Forcing frequency (ignored if forcing == 0)
omega_flow = -2e-6
amp_topo = 1.0
forcing_frequency = m*omega_flow  # negative is prograde
...
# ------------------------------------------------------------------------------------------------------ Simple buoyancy
# ----------------------------------------------------------------------------------------------------------------------
simple_buoyancy = 0 # If set to 1, thermal equation is ignored and the buoyancy profile appears in the momentum equation (ignored for eigenvalue problems).
