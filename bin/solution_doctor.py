...
import utils as ut
import utils4postprocessing as upp
...
def main(ncpus):
    ...
    #print(' ___ ______________ ______________ __________ __________ __________ __________ __________ __________')
    #print(' ‾‾‾ ‾‾‾‾‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾')
    print('\n  ✪      Damping       Frequency     Resid0     Resid1     Resid2     Tor/Pol    Mag/Kin    MagTorq ')
    print(  ' ‾‾‾ ‾‾‾‾‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾ ‾‾‾‾‾‾‾‾‾‾')
    ...
    for i in range(success):
        ...
        # resid1 is the relative residual of 2*sigma*KE - Dkin - Wlor -Wthm + Dohm - pvf = 0
        ...
        print(2*sigma*TE[i], Dthm[i], Wadv_thm[i], resid3[i])
    
        # -----------------------------------------------------------------------------------------------------------------
        print(' {:2d}   {: 12.9f}   {: 12.9f}   {:8.2e}   {:8.2e}   {:8.2e}   {:8.2e}   {:8.2e}   {:8.2e}'.format(i, sigma,\
         w, resid0[i], resid1[i], resid2[i], KT[i]/KP[i], ME[i]/KE[i], 2*np.abs(mtorq[i])/np.sqrt(KE[i]) ))
