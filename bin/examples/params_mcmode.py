...
if comp_source == 'differential':
    Ra_comp = Ra_comp_gap /(1.0-ricb)**3 # differential heating
elif comp_source == 'internal':
    Ra_comp = Ra_comp_gap /(1.0-ricb)**4 # internal heating
