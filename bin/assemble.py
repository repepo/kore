...
def main():
	...
	for k,l in enumerate(loc_top): # 2curl hydro eqs
		...
		if par.compositional == 1 : # include the compositional buoyancy force

			# Buoyancy force, compositional terms
